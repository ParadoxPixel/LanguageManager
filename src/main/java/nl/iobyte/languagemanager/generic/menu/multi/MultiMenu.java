...
public class MultiMenu implements IMenu {
    ...
    private Collection<Integer> page_sizes;
    ...
    public MultiMenu(String title, Collection<Integer> page_sizes) {
        this.title = title;
        this.page_sizes = page_sizes;
        buildPages();
    }

    public MultiMenu(String title, Collection<Integer> page_sizes, boolean locked) {
        this.title = title;
        this.page_sizes = page_sizes;
        this.locked = locked;
        buildPages();
     ...
     * @return int
     */
    public Collection<Integer> getPageSizes() {
        return page_sizes;
    }
     ...
     * @return HashMap
     */
    public Map<Integer, MenuItem> getItems(int page) {
        if(page < 1)
            return null;
     ...
     * @return IMenu
     */
    public MultiMenu setItems(Map<Integer, MenuItem> items) {
     ...
     * @return IMenu
     */
    public MultiMenu setItems(int page, Map<Integer, MenuItem> items) {
        if(page < 1)
            return this;
    ...
    /**
     * Update item on first page to ItemStack
     * @param slot int
     * @param itemStack ItemStack
     * @return IMenu
     */
    public IMenu updateItem(int slot, ItemStack itemStack) {
        int[] data = getSlot(slot);
        if(data == null)
            return this;

        return updateItem(data[0], data[1], itemStack);
    }
    ...
    /**
     * Update item on page to ItemStack
     * @param page int
     * @param slot int
     * @param itemStack ItemStack
     * @return IMenu
     */
    public IMenu updateItem(int page, int slot, ItemStack itemStack) {
        MenuPage mp = getPage(page);
        if(mp == null)
            return this;

        mp.updateItem(slot, itemStack);
        return this;
    }
