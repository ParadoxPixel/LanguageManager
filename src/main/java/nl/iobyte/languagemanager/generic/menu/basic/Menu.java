package nl.iobyte.languagemanager.generic.menu.basic;
...
public class Menu implements IMenu {
    ...
    public IMenu setItems(Map<Integer, MenuItem> items) {
     ...
     */
    public IMenu build() {
        inventory = Bukkit.createInventory(this, MenuAPI.toSize(size), Color.parse(title));
